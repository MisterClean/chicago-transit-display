...
Source code licensing does not grant rights to upstream data or map services. Operators must review the applicable provider terms for their public display. No third-party logos are included.
...
| Metra | [Developers](https://metra.com/developers) | Pending; demo times are illustrative, no production timetable claim |
