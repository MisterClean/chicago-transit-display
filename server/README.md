...
The [CTA developer review](../docs/cta-compliance-review.md) records branding corrections and remaining live-key checks. Bus v3 dynamic action flags preserve cancellations and pickup-skipped service, hide invalidated trips, and reject unrecognized actions. Mixed scheduled/live train times are labeled individually in the browser.
